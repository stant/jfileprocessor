...
Place to get the official versions (some sites are behind):
![github main](https://github.com/stant/jfileprocessor)
![github main](https://github.com/stant/jfileprocessor/releases)
